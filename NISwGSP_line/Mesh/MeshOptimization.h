...
protected:
	...
	void setWeightToLinePreservingTerm(const double _weight);
	...
	void reserveData_line(vector<Triplet<double> > & _triplets,
						  vector<pair<int, double> > & _b_vector,
						  const int _start_index);
	...
	void prepareLinePreservingTerm(vector<Triplet<double> > & _triplets,
		                           vector<pair<int, double> > & _b_vector) const;
...
private:
	...
	int getLinePreservingTermEquationCount() const;
